            ...
            <div class="formActtion">
                <form id="formDaftar" action="<?= base_url('sale/konfirmasi') ?>" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input pattern=".{4,}" required title="Masukkan Nama Lengkap" name="namaCustomer" type="text" class="form-control" id="namaCustomer" maxlength="30" placeholder="Nama" value="<?= $sessionData['namaCustomer'] ?>">
                    </div>
                    <div class="form-group">
